...
{
    public class EsgotarContentorController : Controller
    {
        private ControleContentoresEntities db = new ControleContentoresEntities();

        // GET: EsgotarContentor
        ...
        // GET: EsgotarContentor/Details/5
        ...
        // POST: EsgotarContentor/Delete/5
